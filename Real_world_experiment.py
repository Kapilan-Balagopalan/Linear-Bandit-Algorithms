...
for j in tqdm(range(n_trials)):
    ...
    for name in algo_names:
        ...
        algo_list[i] = bandit_factory(test_type,name,X_final,R_true*Norm_Mismatch,S_true*Noise_Mismatch , n,opt_coeff[i],emp_coeff[i],n_mc_samples, True, 5)
